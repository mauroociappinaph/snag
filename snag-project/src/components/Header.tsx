    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link to="/" className="text-gray-800 hover:text-blue-500 transition-colors font-medium">Inicio</Link>
          ...
          <Link to="/login" className="text-gray-800 hover:text-blue-500 transition-colors font-medium">Registrarse</Link>
          <Link
            to="/register"
